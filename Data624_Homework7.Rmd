...
So there are 28 columns having missing values.
...
We will first look into pairwise correlation above 0.90 and remove the predictors having correlation with cutoff 0.90.
