...
ap <- autoplot(myts_train) + 
  autolayer(myts_train_hw, PI=F, series='Multiplicative') +
  autolayer(myts_train_hwd, PI=F, series='Multiplicative with damped trend') + 
  autolayer(myts_train_sn, PI=F, series='Seasonal Naive') + 
  autolayer(myts_test, PI=F, series='Test set') + 
  theme(legend.position = "top") + 
  ylab("Retail Sales")
